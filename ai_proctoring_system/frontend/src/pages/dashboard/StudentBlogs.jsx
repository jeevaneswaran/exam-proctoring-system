                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 font-medium">Explore insights and knowledge shared by your teachers</p>
                        </div>
                    </div>
                    ...
                    <div className="relative w-full md:w-96">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-3 bg-gray-100 border-none rounded-2xl focus:ring-2 focus:ring-orange-500 outline-none transition-all font-medium"
                        />
                    </div>
                </div>
            </header>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {filteredBlogs.map((blog) => (
                            <article key={blog.id} className="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group">
                                ...
                                <div className="p-6">
                                    ...
                                    <h3 className="text-xl font-black text-gray-900 mb-3 leading-tight group-hover:text-orange-600 transition-colors line-clamp-2">
                                        {blog.title}
                                    </h3>
                                    ...
                                    <button className="flex items-center gap-2 text-sm font-black text-orange-600 group-hover:gap-4 transition-all uppercase tracking-widest">
                                        Read More
                    ...
                    <div className="text-center py-20 bg-white rounded-[40px] border border-dashed border-gray-200">
                        ...
                        <h2 className="text-2xl font-black text-gray-900 mb-2">No blogs found</h2>
