        ...
        <div className="min-h-screen bg-[#F8F9FA] flex">
            ...
            <main className="flex-1 p-8 lg:p-12 max-w-7xl mx-auto w-full">
                <header className="mb-12">
                    ...
                    <h1 className="text-4xl lg:text-5xl font-black text-gray-900 dark:text-white tracking-tight">Global Announcements</h1>
                </header>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    {/* Compose Notice */}
                    <div className="lg:col-span-1">
                        <div className="bg-white dark:bg-gray-900 p-10 rounded-[40px] border border-gray-100 dark:border-gray-800 shadow-sm sticky top-12">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-6 py-5 bg-gray-50 dark:bg-gray-950 border-2 border-transparent focus:border-amber-500 rounded-[30px] outline-none transition-all font-bold text-gray-700 resize-none shadow-inner"
                                    ></textarea>
                                </div>
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`flex-1 py-4 px-4 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-all border-2 ${importance === level.id
                                                        ...
                                                        : `bg-white text-gray-400 border-gray-100 dark:border-gray-800 hover:border-${level.color}-200`}`}
                                                >
                        ...
                        <div className="mt-8 bg-amber-50 p-8 rounded-[40px] border border-amber-100 shadow-sm overflow-hidden relative">
                            ...
                            <div className={`p-5 rounded-2xl shadow-sm border ${importance === 'urgent' ? 'bg-red-100 text-red-900 border-red-200' : 'bg-white dark:bg-gray-900 text-amber-800 border-white'}`}>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-xl font-black text-gray-900 dark:text-white">Live Announcements Feed</h2>
                            <span className="px-5 py-2 bg-gray-100 dark:bg-gray-800 rounded-full text-[10px] font-black uppercase text-gray-500 dark:text-gray-400 tracking-widest">
                        ...
                        {loading ? (
                            ...
                            <div className="space-y-6">
                                {notices.map((notice) => (
                                    <div key={notice.id} className="bg-white dark:bg-gray-900 p-10 rounded-[40px] border border-gray-100 dark:border-gray-800 shadow-sm group hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
                                        ...
                                        <div className="flex items-start justify-between gap-8">
                                            <div className="flex-1">
                                                ...
                                                <p className="text-xl font-bold text-gray-800 dark:text-gray-100 leading-relaxed">
                                                    {notice.content}
                                                </p>
                                            </div>
                                            <button
                                                onClick={() => deleteNotice(notice.id)}
                                                className="p-4 bg-gray-50 dark:bg-gray-950 text-gray-400 hover:bg-red-50 hover:text-red-600 rounded-2xl transition-all opacity-0 group-hover:opacity-100"
                                            >
                            ...
                            <div className="flex flex-col items-center justify-center py-40 bg-white dark:bg-gray-900 rounded-[40px] border border-gray-100 dark:border-gray-800 border-dashed">
